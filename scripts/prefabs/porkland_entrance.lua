...
local function OnActivate(inst)
	...
	local function startnextmode()
		...
		if not SaveGameIndex:OwnsMode(targetmode) then
			...
			TravelBetweenWorlds(targetmode, portal_event, 7.5, {"chester_eyebone", "packim_fishbone"})
		end
	end
...
local function fn(Sim)
    ...
    anim:PlayAnimation("place", false)
    anim:PushAnimation("idle_off", false)
...
return Prefab( "common/porkland_entrance", fn, assets, prefabs),
	   ...
	   Prefab( "common/porkland_exit", exit_fn, assets, prefabs),
