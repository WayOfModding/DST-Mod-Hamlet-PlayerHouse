...
local function fn(anim,loot, onground, minimapicon, talker, collision)  
    ...
    if loot then
        for i,item in ipairs(loot)do
            inst.components.lootdropper:AddLoot(item)
        end
    end
...
return Prefab("porkland_intro",         function() return introfn() end, assets, prefabs),
       Prefab("porkland_intro_chameleon_child",    function() return introchildfn() end, assets, prefabs),
       Prefab("porkland_intro_basket",  function() return fn("basket",{"boards"},nil,"balloon_wreckage",nil,true) end, assets, prefabs),
       Prefab("porkland_intro_balloon", function() return fn("balloon",{"fabric"} ,nil,nil,nil,true) end, assets, prefabs),
       Prefab("porkland_intro_trunk",   function() return fn("trunk",{"trinket_8"},nil,nil,nil,true) end, assets, prefabs),
       Prefab("porkland_intro_suitcase",function() return fn("suitcase",{"razor"} ,nil,nil,nil,true) end, assets, prefabs),
